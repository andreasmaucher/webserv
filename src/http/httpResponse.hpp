...
//Common headers:
// Content-Type: Specifies the media type of the body (e.g., Content-Type: text/html).
...
// Transfer-Encoding: Used when the response body is sent in chunks (Transfer-Encoding: chunked).